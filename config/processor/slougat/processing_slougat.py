...
"""
Processor class for Slougat copyright to SAM.
"""
...
class SlougatImageProcessor(SamImageProcessor):
    def resize(
        self,
        image: np.ndarray,
        size: Dict[str, int],
        ...
        **kwargs,
        ...
        output_size   = (size["longest_edge"], size["longest_edge"])
...
class SlougatProcessor(ProcessorMixin):
    r"""
