...
export CMD="train_via_accelerate.py --task train --model flougatU_small --Dataset uparxive --root_name data \
--batch_size 14 --lr 0.0005 --num_workers 12 --random_dpi False  \
--preload_weight pretrain_weights/Flougat_start_weight_somehow.bin --load_weight_partial  --load_weight_ignore_shape \
--coordinate_retreive_method mapping_coordinate_hard --trial_name flougatU_small_sketch \
--start_count 3 --start_weight 2 --token_weight 1 --bbox_weight 2 --epochs 300 \
--use_wandb "
