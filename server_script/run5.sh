...
--batch_size 8 --lr 0.00005 --use_wandb --num_workers 12 --random_dpi False \
--load_weight_partial  \
--preload_state \
--preload_weight checkpoints/Lougat/Flougat_small/flougat_map_hard_more/best/weight/epoch0258/pytorch_model.bin \
--trial_name flougatX_small --coordinate_retreive_method mapping_coordinate_hard \
--start_count 5 --start_weight 5 --token_weight 1 --bbox_weight 2 --epochs 100 --load_weight_ignore_shape"""
