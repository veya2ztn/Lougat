...
--batch_size 14 --lr 0.00001 --use_wandb --num_workers 12 --random_dpi False \
--load_weight_partial  \
--preload_state \
--preload_weight checkpoints/Lougat/Flougat_small/flougat_map_hard_more/best/weight/epoch0258/pytorch_model.bin \
--trial_name flougat_map_start4000 --coordinate_retreive_method mapping_coordinate_hard \
--start_count 1 --start_weight 4000 --token_weight 1 --bbox_weight 10 --epochs 100 --save_every_epoch 10"""
