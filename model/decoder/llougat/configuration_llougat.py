...
class LlougatConfig(LlamaConfig):
    r"""
    ...
    def __init__(self,
        ...
        init_std=0.02,
        coordinate_retreive_method="query_coordinate",
...
class LlougatVEDConfig(VisionEncoderDecoderConfig):
    model_type = "llougat_ved"
    

AutoConfig.register("llougat", LlougatConfig)
AutoConfig.register("llougat_ved", LlougatVEDConfig)
