...
## See https://github.com/huggingface/transformers/blob/cefa0d9808d8dd9e17f730fa3aecba1c9cdb0bf2/src/transformers/models/sam2/modeling_sam2.py
"""PyTorch SAM 2 model."""
...
class Sam2MemoryFuserCXBlock(nn.Module):
    ...
    def __init__(
        ...
        self.drop_path = nn.Identity() #DropPath(drop_path) if drop_path > 0.0 else 
...
AutoModel.register(Sam2Config, Sam2Model)
AutoModel.register(Sam2ImageEncoderConfig, Sam2ImageEncoder)
